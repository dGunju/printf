...
int print_flags(va_list arguments, char *buf, unsigned int ibuf);
int print_width(va_list arguments, char *buf, unsigned int ibuf);
int print_precision(va_list arguments, char *buf, unsigned int ibuf);
int print_size(va_list arguments, char *buf, unsigned int ibuf);
